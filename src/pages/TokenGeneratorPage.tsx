      ...
      <div className="flex justify-between items-end relative">
        ...
        <div className="relative z-10">
          <button
            ...
            className="premium-btn bg-primary text-on-primary font-bold px-5 py-3 rounded-2xl flex items-center gap-2 shadow-glow-primary active:scale-95 transition-transform"
          >
