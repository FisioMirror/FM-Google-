  ...
  const loadData = async () => {
    ...
    try {
      ...
      if (isEmpty) {
        ...
        setExercises(PRIMARY_DEMO_PATIENT.exercises.map(ex => ({
          id: ex.id,
          name: ex.ejercicio_nombre,
          subtitle: `${ex.series} series • ${ex.repeticiones} repet.`,
      ...
      setTherapist(therapistName || PRIMARY_DEMO_PATIENT.referringDoctor);
    } catch {
      setKpi({
        streak: 4,
        totalSessions: PRIMARY_DEMO_PATIENT.sessionsCompleted,
      ...
      setTherapist(PRIMARY_DEMO_PATIENT.referringDoctor);
    } finally {
      setLoading(false);
    }
  };
      ...
      <section className="space-y-1 relative section-bg-teal p-4 rounded-3xl">
        ...
        <div className="flex items-center gap-4 relative z-10">
          ...
          <div className="flex-1">
            ...
            <p className="text-on-surface-variant text-body-lg relative">Comienza tu rutina diaria guiada por IA y biofeedback</p>
          </div>
        </div>
      </section>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <section className="section-bg-teal p-4 rounded-3xl">
            <div className="relative overflow-hidden glass-card vibrant-hover shadow-ambient-teal rounded-3xl p-6 min-h-[220px] flex flex-col justify-between group hover-lift accent-teal shimmer-border">
              <BorderBeam size={100} duration={6} colorFrom="#14b8a6" colorTo="#38bdf8" />
